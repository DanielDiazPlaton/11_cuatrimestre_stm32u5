...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
extern osMessageQueueId_t rxQueue; // Cola de mensajes para datos recibidos
extern uint8 rxBuffer[BUFFER_SIZE];  // Buffer de recepción
extern uint16 rxIndex;  // Índice para el buffer
/* USER CODE END PV */
